...
class PHP_Compatibility_Checker {
	...
	{{/messages}}</textarea>
			...
			// Catching and logging the exception to ensure the scan page rendering does not break the entire admin page.
			error_log( 'Error rendering scan page: ' . $e->getMessage() );
		}
	}
