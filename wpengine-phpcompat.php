...
class WPEngine_PHPCompat {
	...
	function settings_page() {
		...
		<div class="wrap wpe-pcc-wrap">
			<h1><?php esc_attr_e( 'PHP Compatibility Checker' ) ?></h1>
			<div class="wpe-pcc-main">
				...
				<div class="wpe-pcc-scan-options">
					...
					<table class="form-table wpe-pcc-form-table">
						<tbody>
							<tr>
								<th scope="row"><label for="phptest_version"><?php esc_attr_e( '1. What version of PHP do you want to test?', 'php-compatibility-checker' ); ?></label></th>
								<td>
									<?php
							...
							<tr>
								<th scope="row"><label for="active_plugins"><?php esc_attr_e( '2. What plugins/themes do you want to scan?', 'php-compatibility-checker' ); ?></label></th>
					...
					<div class="wpe-pcc-run-scan">
						<input style="float: left;" name="run" id="runButton" type="button" value="<?php esc_attr_e( 'Scan', 'php-compatibility-checker' ); ?>" class="button-primary" />
						<div class="wpe-tooltip">
							<input style="float: left; margin-left: 5px;" name="run" id="cleanupButton" type="button" value="<?php esc_attr_e( 'Clear results', 'php-compatibility-checker' ); ?>" class="wpe-pcc-clear-results" />
							<span class="wpe-tooltiptext"><?php esc_attr_e( 'This will remove all database options related to this plugin, but it will not stop a scan in progress. If you\'d like to completely remove all data wait for the scan to finish before hitting this button.' ); ?></span>
						</div>
				...
				<div class="wpe-pcc-results">
					<h2><?php printf( 'Scan Results <span style="display:none; visibility:visible; float:none; padding-left: 10px;" class="spinner wpe-pcc-spinner"></span> '); ?></h2>
			...
			<div class="wpe-pcc-aside">
				...
				<div class="wpe-pcc-aside-content">
					<h2>Launch this site in a PHP7 hosting environment and double your site speed!</h2>
					<p>Easily test your site on a PHP7 server or launch your new PHP7 site now!</p>
					<a class="wpe-pcc-button" href="#">Get PHP7 Hosting!</a>

					<hr>

					<h2>Need help making this site PHP7 compatible?</h2>
					<p class="wpe-pcc-attention"><strong>Attention:</strong> Not all errors are show-stoppers. <a href="#">Test this site in PHP7</a> to see if just works.</p>
					<div class="wpe-pcc-dev-helper">
						<p class="title"><strong>Get help from WP Engine partners</strong></p>
						<img src="http://placehold.it/233x105" />
						<p>We partner with the brightest agency minds that are dedicated to delivering enterprise grade solutions in WordPress.</p>
					</div> <!-- /wpe-pcc-dev-helper -->

					<div class="wpe-pcc-dev-helper">
						<p class="title"><strong>Get a fast quote from Codeable</strong></p>
						<img src="http://placehold.it/233x105" />
						<p>Here is some text about this thing right here that could be a few lines long.</p>
					</div> <!-- /wpe-pcc-dev-helper -->
